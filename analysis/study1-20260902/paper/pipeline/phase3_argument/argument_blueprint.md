...
- **Evidence**: disclosed vs no mention on the four primary outcomes all n.s. (p ≥ .11), point estimates small and slightly negative (d to −.24); TOST excludes |d| ≥ .50; participant-unit BF01 3–12 depending on the outcome (Table 8; the earlier clip-row values of 5.5–20 overstated the evidence by about 1.7× and are superseded); intellectual = mobility (C4); pooled contrast same (C5).
